...
import { FlashMintLeveragedAerodrome } from "./FlashMintLeveragedAerodrome.sol";
 ...
 */
contract FlashMintLeveragedExtendedAerodrome is FlashMintLeveragedAerodrome, Ownable {
    ...
    */
    constructor(
        ...
        public
        FlashMintLeveragedAerodrome(_addresses, _setController, _debtIssuanceModule, _aaveLeverageModule, _aaveV3Pool, _vault)
    {
    }
    ...
    function redeemSetForExactERC20(
        ...
        DEXAdapterV4.SwapData memory _swapDataCollateralForOutputToken,
        DEXAdapterV4.SwapData memory _swapDataDebtForCollateral,
        DEXAdapterV4.SwapData memory _swapDataOutputTokenForCollateral,
        DEXAdapterV4.SwapData memory _swapDataOutputTokenForETH,
    ...
    function issueSetFromExactERC20(
        ...
        DEXAdapterV4.SwapData memory _swapDataDebtForCollateral,
        DEXAdapterV4.SwapData memory _swapDataInputTokenForCollateral,
        DEXAdapterV4.SwapData memory _swapDataInputTokenForETH,
        uint256 _priceEstimateInflator,
        uint256 _maxDust
    )
        external
        ...
        returns (uint256)
    {
        ...
        if( _inputToken == DEXAdapterV4.ETH_ADDRESS) {
