...
/**
 * @title BaseAuctionRebalanceExtension
 * @author Index Coop
 *
 ...
 */
contract BaseAuctionRebalanceExtension is BaseExtension {
    ...
    ISetToken public immutable setToken;                       // SetToken instance associated with BaseManager
     ...
     * 
     * @param _manager                  Address of BaseManager contract 
    ...
    */ 
    ...
    /**
     * @dev ONLY OPERATOR: Initializes AuctionRebalanceModuleV1 on the SetToken associated with the BaseManager.
     */
    function initialize() external onlyOperator {
        bytes memory callData = abi.encodeWithSelector(IAuctionRebalanceModuleV1.initialize.selector, setToken);
