...
import {
  ...
  FlashMintLeveragedMorphoV2__factory,
...
export default class DeployExtensions {
  ...
  public async deployFlashMintLeveragedZeroExBalancerFL(
    setControllerAddress: Address,
    basicIssuanceModuleAddress: Address,
    morphoLeveragedModuleAddress: Address,
    aaveLeveragedModuleAddress: Address,
    ...
    console.log("Deploying FlashMintLeveragedZeroExBalancerFL", {
      wethAddress,
      setControllerAddress,
      basicIssuanceModuleAddress,
      morphoLeveragedModuleAddress,
    ...
    return await new FlashMintLeveragedZeroExBalancerFL__factory(this._deployerSigner).deploy(
      setControllerAddress,
      basicIssuanceModuleAddress,
      morphoLeveragedModuleAddress,
      aaveLeveragedModuleAddress,
  ...
  public async deployFlashMintLeveragedMorphoV2(
    ...
    console.log("Deploying FlashMintLeveragedMorphoV2", {
      wethAddress,
      quickRouterAddress,
      sushiRouterAddress,
      uniV3RouterAddress,
    ...
    return await new FlashMintLeveragedMorphoV2__factory(
      // @ts-ignore
      {
        [linkId]: dexAdapter.address,
      },
