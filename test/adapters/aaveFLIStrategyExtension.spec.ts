...
import { FlexibleLeverageStrategyExtension, BaseManager, TradeAdapterMock, ChainlinkAggregatorV3Mock, AaveFLIStrategyExtension } from "@utils/contracts/index";
import { AaveLeverageModule, CompoundLeverageModule, ContractCallerMock, DebtIssuanceModule, SetToken } from "@utils/contracts/setV2";
...
describe("FlexibleLeverageStrategyExtension", () => {
  ...
  let flexibleLeverageStrategyExtension: AaveFLIStrategyExtension;
  ...
  const initializeRootScopeContracts = async () => {
    ...
    flexibleLeverageStrategyExtension = await deployer.adapters.deployAaveFLIStrategyExtension(
  ...
  describe("#constructor", async () => {
    ...
    async function subject(): Promise<AaveFLIStrategyExtension> {
      return await deployer.adapters.deployAaveFLIStrategyExtension(
